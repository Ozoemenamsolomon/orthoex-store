				...
				<StyledSideBar>
					...
					<StyledSideBarContent>
						<StyledSideBarNavLink>
							{navLinks.map((navLink, index) => (
								<li 
								style={{color: `${navLink.to === router.pathname ? "var(--oex-orange)": ""}`}}
								key={`nav-link-${navLink.name}-${index}`} onClick={() => setIsNavOpen(prev => !prev)}>
