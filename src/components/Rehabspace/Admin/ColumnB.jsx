...
import { EmailIcon, PhoneIcon, ScheduleIcon, SessionBooked, SessionCancelled, SessionPurchsed, SessionUsed, SessionsIcon, WhatsAppIcon } from '../../../data/rehabspace'

const ColumnB = ({type, toggle, setToggle}) => {

  return (
    <div className='p-4 overflow-hidden '>
        {type && <button type="button" onClick={()=>setToggle('')}>{`< Back`}</button>}
        ...
        <div className="pt-6">
              ...
              <div className="flex justify-center">
                ...
                <div className="">
                  ...
                  <div className='text-sm'>
                    Idrisrash2017@gmail.com<br/>+2348109945686<br/>
          ...
          <div className='flex justify-center'>    <PhoneIcon/></div>
              <div className="">Call</div>
            </div>
            <div className="text-center flex flex-col justify-center">
             <div className='flex justify-center'> <WhatsAppIcon/></div>
          ...
          <div className='flex justify-center'>    <EmailIcon/></div>
            ...
            <div className="text-center flex flex-col justify-center">
             <div className='flex justify-center'> <ScheduleIcon/></div>
              <div className="">Sechedule <br/> appointment</div>
            </div>
          </div>
        </div>
        ...
        {
          ['cancelled', 'booked', 'purchased', 'used', 'used', 'used']?.map((item,i)=>(
