...
//     CONSTRAINT users_email_key UNIQUE ("userEmail")
// )
...
const sampleUser = {
  registrationDate: '2024-01-04T12:30:00Z',
...
//     "sessionBalance" numeric null,
//     constraint users_pkey primary key (id),
//     constraint users_email_key unique ("customerEmail")
//   ) tablespace pg_default;
...
const customerAccountHistoryTable = {
  id: 'bigint generated by default as identity',
  created_at: 'timestamp with time zone not null default now()',
  userEmail: 'text',
  customerEmail: 'text',
...
console.log(customerAccountHistoryTable);
